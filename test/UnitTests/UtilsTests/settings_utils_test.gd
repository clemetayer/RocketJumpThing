...
func testload_cfg_gameplay_file() -> void:
	...
	cfg.set_value(SettingsUtils.GAMEPLAY_SECTION_MOVEMENT, SettingsUtils.GAMEPLAY_KEY_AIR_STRAFE_MANEUVERABILITY, 3.2)
	# test
	...
	assert_float(SettingsUtils.settings_data.gameplay.air_strafe_maneuverability).is_equal_approx(3.2, FLOAT_APPROX)
...
func testgenerate_cfg_gameplay_file() -> void:
	...
	SettingsUtils.settings_data.gameplay.air_strafe_maneuverability = 1.5
	# test
	...
	assert_float(cfg.get_value(SettingsUtils.GAMEPLAY_SECTION_MOVEMENT, SettingsUtils.GAMEPLAY_KEY_AIR_STRAFE_MANEUVERABILITY)).is_equal_approx(1.5, FLOAT_APPROX)