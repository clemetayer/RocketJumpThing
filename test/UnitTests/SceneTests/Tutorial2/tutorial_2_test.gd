...
#---- PRE/POST -----
func before():
	scene_path = "res://Game/Scenes/Tutorial/Tutorial2/tutorial_2.tscn"
	.before()
...
func test_song() -> void:
	assert_str(scene_instance.PATHS.bgm.path).is_equal("res://Game/Common/Songs/Tutorial2/tutorial_2.tscn")
